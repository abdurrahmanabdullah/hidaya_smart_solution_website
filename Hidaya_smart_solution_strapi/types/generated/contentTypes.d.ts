...
export interface ApiDynamicPageDynamicPage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    keyPart: Attribute.Component<'dynamic.dynamic'>;
    KeyFeatures: Attribute.Component<'dynamic.key-features'>;
    Description: Attribute.Component<'dynamic.description', true>;
    Footer: Attribute.Component<'dynamic.footer'>;
